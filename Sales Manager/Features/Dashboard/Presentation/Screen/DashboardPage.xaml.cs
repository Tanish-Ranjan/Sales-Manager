...
namespace Sales_Manager.UI.Screens.Dashboard
{
	public sealed partial class DashboardPage : Page
	{
		...
		{
			InitializeComponent();
			DataContext = ((App)Application.Current).Container.GetService<IDashboardViewModel>();
		}
		...
		private void Edit_Click(object sender, RoutedEventArgs e)
		{
			...
			var viewModel = (IDashboardViewModel)DataContext;
		...
		private void ScrollViewer_ViewChanged(object sender, ScrollViewerViewChangedEventArgs e)
		{
			...
			{
				((IDashboardViewModel)DataContext).LoadNextSetOfRecords();
			}
		}
