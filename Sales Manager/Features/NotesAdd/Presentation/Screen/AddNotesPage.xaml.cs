...
namespace Sales_Manager.Features.NotesAdd.Presentation.Screen
{
	public sealed partial class AddNotesPage : Page
	{
		...
		{
			InitializeComponent();
			DataContext = ((App)Application.Current).Container.GetService<IAddNotesViewModel>();
		}
		...
		private void Edit_Click(object sender, RoutedEventArgs e)
		{
			...
			var viewModel = (IAddNotesViewModel)DataContext;
		...
		private void ScrollViewer_ViewChanged(object sender, ScrollViewerViewChangedEventArgs e)
		{
			...
			{
				((IAddNotesViewModel)DataContext).LoadNextSetOfRecords();
			}
		}
